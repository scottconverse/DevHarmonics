...
- OpenRouter spending gates now serialize concurrent Workbench and run invocations through their durable cost receipts, preventing simultaneous requests from oversubscribing per-run or monthly limits.
