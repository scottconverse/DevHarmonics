...
- OpenRouter spending gates now atomically reserve concurrent Workbench and run spend in the shared SQLite ledger through each durable cost receipt, preventing separate CLI and dashboard processes from oversubscribing per-run or monthly limits.
